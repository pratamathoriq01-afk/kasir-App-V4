...
export async function printViaWebUSB(
  ...
  if (
    ...
    return await printViaWebSerial(transaction, mode, true);
  }
  ...
  try {
    ...
    try {
      ...
      console.warn("Chrome WebUSB Protected Class / Driver active, connecting via Serial COM bridge:", claimErr);
      return await printViaWebSerial(transaction, mode, true);
    }
